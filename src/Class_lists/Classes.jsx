...
function Classes() {
    ...
    const handleSubmit = async (event) => {
        ...
        if (isValid) {
            ...
            try {
                ...
                const url = editingId
                    ? `${config.API_URL}/edit-class/${editingId}`
                    : `${config.API_URL}/add-class`;
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            const response = await fetch(`${config.API_URL}/delete-class/${id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                },
                        ...
                        {isProfileDropdownOpen && (
                            ...
                            >
                                <li>
                                   <a
  href="#"
  className="dropdown-item px-3 py-2 text-dark hover:bg-gray-100 focus:bg-gray-200 active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300"
>
  Settings
</a>
<a
